...
const BorderedButtonRightOrnament: React.FC = props => {
  const ornament = useStaticQuery<{
    ...
    query {
      placeholderImage: file(relativePath: { eq: "ic_decoration_right.png" }) {
        childImageSharp {
          fluid(maxWidth: 126) {
  ...
  return (
    ...
    //     borderImage: `url(${(imgData as FluidObject).src}) 70 / 70px repeat`,
    //   }}
    // />
    <Img
...
export default BorderedButtonRightOrnament;
